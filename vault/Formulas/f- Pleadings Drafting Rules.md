...
lecture: []
tags: [formula]
belongs-to: ["[[Pleadings]]", "[[Cause of Action]]"]
---
# Pleadings Drafting Rules

$$ \text{Valid Pleading} = \text{Clear Statement} \land \text{Facta Probanda Only} \land \text{Plausible Cause/Defence} \land \text{Clear Prayer} $$
...
The technical and substantive validity of a pleading, shielding it from exceptions (vague and embarrassing or failing to disclose a cause of action).
...
Chapter 05 (Page 54), Uniform Rule 18

# South African Litigation Skills & Etiquette: Agent Context Guide

This document provides essential style guidelines, behavioral constraints, and legal context derived from Chris Marnewick SC’s *Litigation Skills for South African Lawyers*. Any agent assisting practitioners in this workspace must adhere to the rules, protocols, and drafting standards summarized below.
...
* **Duty to the Court (Do Not Mislead):**
  ...
  * Do not knowingly or recklessly deceive the court on facts or law (*"In matters of fact, it is counsel's duty not to mislead the court"*).
  * Do not tender evidence known to be false.
  * Do not present specious, frivolous, or obviously untenable points.
  * Do not withhold adverse legal authorities from the court.
* **Duty to the Client (Provide Fearless Advocacy):**
  * Provide objective, practical advice.
  * Strive to protect the client's legitimate interests.
  * Fearlessly stand on the right to present the client's case fully at every stage of the proceedings.
* **Prosecutor's Additional Duty:** Prosecutors must be fair and must not withhold evidence that may exonerate the accused.
...
* **High Court / Supreme Court of Appeal / Constitutional Court:**
  ...
  * Refer to other judges by their full title (*"His Lordship, Mr Justice de Villiers"* on first occasion, then *"His Lordship"*).
* **Magistrates' Court:**
  * Address the magistrate as **"Your Worship"**.
* **In Chambers:**
...
* **Robing Rules:**
  ...
  * Never robe or disrobe inside the courtroom; use designated robing areas or private spaces.
* **Greetings & Introductions:**
  * Before your first appearance before a judge in an opposed matter, go to the judge's chambers early in the company of your opponent to introduce yourself.
  * Men introduce themselves by surname alone: *"Judge, my name is Mazibuko and I am from the Pietermaritzburg Bar."*
  * Women state their prefix preference: *"I am Mrs Singh and I am a partner in the firm Goodall and Singh, Judge."*
* **Bowing & Adjournments:**
  * When entering or exiting a courtroom in session, stop, face the bench, and bow slightly. Do not turn your back on the judge when leaving.
  * Stand when the judge enters/leaves and return the bow.
  * Never leave the courtroom before the judge if you are the last counsel or second-to-last counsel in court (traditionally, at least two counsel remain in court at all times to assist the bench if needed).
* **Acknowledging Rulings:**
...
* **Opposing Counsel:**
  ...
  * Play the ball, not the man. Attack the point/argument, not the person who made it. Avoid adjectives like "silly", "petty", or "catty".
* **Witnesses:**
  * Treat all witnesses with courtesy and respect. Address them formally as "Mister", "Mrs", "Ms", or by their professional rank ("Sergeant", "Doctor", "Professor").
  * Do not call a witness a "liar" directly. Instead, expose inconsistencies and let the court draw the conclusion.
...
* **The Prayer:**
  * Every statement of claim (or particulars of claim) must conclude with a clear **prayer** specifying the exact relief sought. A pleading without a prayer is deficient and excipient (vague and embarrassing, or failing to disclose a cause of action).
* **Drafting the Plea:**
  * The defendant must answer every allegation in the plaintiff’s statement of claim line-by-line.
...
2. **Examination-in-Chief:**
   ...
   * **Constraint:** No leading questions are permitted on material or disputed facts.
   * *Refreshing memory:* A witness may refresh their memory from notes only if the notes were made at or near the time of the event, while facts were fresh in their mind, and with permission from the court.
3. **Cross-Examination:**
   * **The Duty to Put Your Version:** You must put your client's version to the opposing witness on points where your own witnesses will contradict them. If you fail to do so, you cannot later argue that the witness's evidence on that point should be rejected.
   * Only put parts of the version the witness is reasonably expected to know or comment on.
   * *Restrictions:* Focus cross-examination on the merits (testing reliability of observations and memory) and credibility (honesty, inconsistencies).
4. **Re-Examination:**
   * Strictly limited to clarifying matters raised during cross-examination.
   * No new areas may be explored without leave of the court.
5. **Closing Argument:**
   * Summarize the proven facts, apply the legal principles, and address why the relief in the prayer should be granted.

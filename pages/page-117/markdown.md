...
You should analyse the evidence of each witness and summarise the salient parts of their evidence. This does not mean that one has to recount word for word what each [Page 195] witness has said in his written statement. In an RAF case where negligence is or may be an issue you might mention the following:

...
```mermaid
graph LR
    A["Academic Knowledge<br>(What the law is)"] --> B["Practical Skills<br>(How to practise law)"]
    B --> C["Competent Advocacy<br>(Doing it)"]
...
```mermaid
graph TD
    A[ABA Fundamental Skills] --> B[Analytical]
    A --> C[Practical]
    A --> D[Professional]
    
    B --> B1[Problem Solving]
    B --> B2[Legal Analysis & Reasoning]
    B --> B3[Legal Research]
    
    C --> C1[Fact Investigation]
    C --> C2[Communication]
    C --> C3[Counselling]
    C --> C4[Negotiation]
    C --> C5[Litigation & ADR]
    C --> C6[Organisation & Management]
    
    D --> D1[Ethical Dilemmas]
    
    style A fill:#EEEDFE,stroke:#534AB7
    style B fill:#E6F1FB,stroke:#185FA5
    style C fill:#E1F5EE,stroke:#0F6E56
    style D fill:#FAECE7,stroke:#D85A30
```

...
[[Page-127|← Previous Page]] | [[Dashboard|Dashboard]] | [[Page-129|Next Page →]]

---

hearsay or character evidence may creep in. This should, where appropriate, be kept separate, in an addendum or similar document. In short, the statement should be a "proof of evidence", a blueprint for the evidence-in-chief of the witness. In a proper case, an arbitration or mediation, the statement can be handed in as evidence of the facts set out in it.
...
All these sources should be studied and incorporated in the statements of the witnesses in order to create a complete medical file for each plaintiff. That medical file should then be put before your expert witnesses for their comment and opinion on the matters referred to in Rule 18(10), namely -
